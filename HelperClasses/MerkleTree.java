...
public class MerkleTree {
  ...
  public boolean findTrans(Transaction tobj,TreeNode node)
  {
      ...
      else if(curr.val.equals(this.get_str(tobj)))
      {
          return true;
      }
      else
      {
          return(findTrans(tobj,node.left) || findTrans(tobj,node.right));
      }
  }
  public TreeNode findNode(Transaction tobj,TreeNode rootnode)
  {
      TreeNode curr = new TreeNode();
      curr = rootnode;
      while(curr.left!=null)
      {
          if(findTrans(tobj,curr.left))
          {
              curr=curr.left;
          }
          else
